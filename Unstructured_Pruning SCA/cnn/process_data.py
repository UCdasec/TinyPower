...
def load_whole_pack(whole_pack, attack_window):
    ...
    allItems = whole_pack.files
    if attack_window:
        print('use the self-defined attack window')
    else:
        print('read the attack window from the dataset package')
...
def process_raw_data(whole_pack, target_byte, network_type='cnn2', attack_window=0):
