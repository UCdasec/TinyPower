...
def load_data_base(whole_pack, attack_window, method, start_idx, train_num=0):
    try:
    ...
    if train_num:
        traces = traces[start_idx: start_idx + train_num, :]
        plain_text = plain_text[start_idx: start_idx + train_num, :]
